...
import { Search, Package, Truck, CheckCircle2, AlertCircle, ArrowRight, Zap, ShieldCheck, Loader2 } from "lucide-react";
...
export default function OrderTrackingPage() {
    return (
        <div className="min-h-screen bg-slate-950 text-slate-200">
            ...
            <Suspense fallback={
                <div className="min-h-screen bg-slate-950 text-slate-200">
                    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 text-center">
