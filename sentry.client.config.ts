...
Sentry.init({
  ...
  // This sets the sample rate to be 10%. You may want this to be 100% while in development and sample less in production
  replaysSessionSampleRate: 0.1,

  // You can define which elements should be masked/blocked here
  integrations: [
