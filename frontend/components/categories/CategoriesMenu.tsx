...
export default function CategoriesMenu({ isOpen }: CategoriesMenuProps) {
    return (
        <div
            className={`absolute top-14 w-72 border rounded-b-xl border-gray-200 shadow-lg z-50 overflow-hidden transition-all duration-300 ease-in-out origin-top ${isOpen
